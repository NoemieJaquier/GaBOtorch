...
from BoManifolds.Riemannian_utils.spd_constraints_utils import max_eigenvalue_constraint, min_eigenvalue_constraint
from BoManifolds.Riemannian_utils.spd_constraints_utils_torch import post_processing_init_spd_torch
...
if __name__ == "__main__":
    ...
    # Define constraints
    min_eigenvalue_ineq_function = functools.partial(min_eigenvalue_constraint,
                                                     min_eigenvalue=min_eigenvalue)
    max_eigenvalue_ineq_function = functools.partial(max_eigenvalue_constraint,
    ...
    post_processing_fct = functools.partial(post_processing_init_spd_torch, min_eigenvalue=min_eigenvalue,
                                            max_eigenvalue=max_eigenvalue)
